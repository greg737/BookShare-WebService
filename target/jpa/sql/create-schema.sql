create table Author (PERSON_ID bigint not null, FIRSTNAME varchar(255) not null, GENDER integer, LASTNAME varchar(255) not null, primary key (PERSON_ID))
...
create table User (PERSON_ID bigint not null, FIRSTNAME varchar(255) not null, GENDER integer, LASTNAME varchar(255) not null, CITY varchar(255), USERNAME varchar(255) not null, primary key (PERSON_ID))
